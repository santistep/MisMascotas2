...
public class MascotasFavoritas extends AppCompatActivity {
    ...
    public void iniciarListaMascotas(){
        ...
        mascotas.add(new Mascota(R.drawable.superdog2,"Mastin",0));
        mascotas.add(new Mascota(R.drawable.dog1,"Facha",0));
        mascotas.add(new Mascota(R.drawable.superdog3,"Falco",0));
        mascotas.add(new Mascota(R.drawable.supercat1,"Merlin",0));
